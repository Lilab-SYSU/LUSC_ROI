...
parser.add_argument('--checkpoint', default='', help='pytorch checkpoint model for resuming trainning')
...
########loading a checkpoint model for resuming training
    ...
    # imshow(out)
    if not os.path.exists(args.output+'/convergence.csv'):
